...
const freeDir = '/Users/huangshuisheng/Desktop/hss/galaxy-s10/billd-desk-admin';
...
if (process.cwd().indexOf('galaxy-s10') !== -1) {
  ...
  clearOld().then(() => {
    ...
    newPkg['name'] = 'billd-desk-admin';
    newPkg['repository']['url'] =
      'https://github.com/galaxy-s10/billd-desk-admin';
    newPkg['bugs']['url'] =
      'https://github.com/galaxy-s10/billd-desk-admin/issues';
